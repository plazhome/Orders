    ...
    return (
        <div className={styles.settingsDashboard}>
            ...
            <div className={styles.tableContainer}>
                ...
                {activeTab === 'shipping' && (
                    <div className={`${styles.shippingSettings} ${styles.forceVisibility}`} style={{
                        position: 'relative', 
                        paddingTop: '60px',
                        marginTop: '30px'
                    }}>
                ...
                {/* Payment Methods Tab */}
                {activeTab === 'payment' && (
                    <div className={`${styles.paymentSettings} ${styles.forceVisibility}`} style={{paddingTop: '60px', marginTop: '30px'}}>
                        {/* Invisible spacer to push content down */}
                        <div style={{height: '80px', marginBottom: '20px'}} aria-hidden="true"></div>
                        <div className={styles.optionsList}>
